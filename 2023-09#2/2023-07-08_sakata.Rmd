...
g <- g + geom_violin(mapping = aes(x=start_m, y=降水量),na.rm = TRUE, colour = '#00009966', fill = 'blue', alpha = 0.1)
g <- g + geom_boxplot(mapping = aes(x=start_m, y=降水量),alpha=0.3, notch = TRUE)
g <- g + geom_point(data=kotoshi,mapping = aes(x=start_m, y=降水量))
plot(g)
