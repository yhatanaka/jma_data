...
allData %<>% mutate(降水量_平年値 = 降水量_平年値 %>% as.character() %>% as.numeric()) %>% mutate(平均気温_平年値 = 平均気温_平年値 %>% as.character() %>% as.numeric()) %>% mutate(日照時間_平年値 = 日照時間_平年値 %>% as.character() %>% as.numeric())
